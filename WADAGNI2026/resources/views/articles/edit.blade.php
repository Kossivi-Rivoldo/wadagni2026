        ...
        <div class="col-md-10 p-4 main-content">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('articles.update', $article->id_art) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_cat" name="id_cat" required>
                                ...
                                @foreach($categories as $categorie)
                                    <option value="{{ $categorie->id }}" {{ $categorie->id == $article->id_cat ? 'selected' : '' }}>
                                        {{ $categorie->nom_cat }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="titre_art" name="titre_art"
                                   value="{{ $article->titre_art }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="extr_art" class="form-label">Extrait</label>
                            <textarea class="form-control" id="extr_art" name="extr_art" rows="2" required>
                                {{ $article->extr_art }}
                            </textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($article->image)
                                <img src="{{ asset('storage/' . $article->image) }}" class="img-fluid mt-2"
                                     style="max-height:150px;" alt="Image actuelle">
                            @endif
                        </div>
